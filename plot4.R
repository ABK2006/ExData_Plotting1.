...
# Arriba izquierda: Global Active Power
...
# Arriba derecha: Voltage
plot(datos_tarea$datetime, datos_tarea$Voltage,
     type = "l",
     xlab = "datetime",
     ylab = "Voltage",
     xaxt = "n")
...
# Abajo derecha: Global Reactive Power
plot(datos_tarea$datetime, datos_tarea$Global_reactive_power,
     type = "l",
     xlab = "datetime",
